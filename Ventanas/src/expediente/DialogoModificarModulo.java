...
public class DialogoModificarModulo extends JDialog {
	private JTextField textFieldNombre;
	private JTextField textFieldNotaEv1;
	private JTextField textFieldNotaEv2;
	private JTextField textFieldNotaEv3;

	public DialogoModificarModulo(JFrame padre, boolean modal, Modulo modulo) {
		super(padre, modal);
