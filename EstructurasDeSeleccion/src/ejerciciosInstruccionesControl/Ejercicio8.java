...
public class Ejercicio8 {
	public static void main(String[] args) {
		...
		if (n < 10) {
			System.out.println("Del reves: " + n_reves / 1000);
		} else if (n < 100) {
			System.out.println("Del reves: " + n_reves / 100);
		} else if (n < 1000) {
			System.out.println("Del reves: " + n_reves / 10);
		} else if (n < 10000) {
			System.out.println("Del reves: " + n_reves);
		} else {
