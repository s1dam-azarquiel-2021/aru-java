...
public class VentanaCenso extends JFrame {
	...
	public VentanaCenso() {
		...
		tablePoblacion.setModel(new DefaultTableModel(new Object[][] {
			{
				null, null
			},
		}, new String[] {
		...
		tableHabitantes.setModel(new DefaultTableModel(new Object[][] {
			{
				null, null, null, null
			},
		}, new String[] {
	...
	private void cargarTablaPoblacion() {
		...
		tablePoblacion.setModel(new DefaultTableModel(datos, new String[] {
			"Poblacion", "Habitantes"
		}) {
			Class[] columnTypes = new Class[] {
				String.class, Integer.class
	...
	private void cargarTablaHabitantes() {
		...
		if (tablePoblacion.getSelectedRow() != -1) {
			lista = daoHabitante.getHabitantesDeUnaPoblacion(
				(String) tablePoblacion.getValueAt(
					tablePoblacion.getSelectedRow(), 0
				)
			);
		} else {
		...
		tableHabitantes.setModel(new DefaultTableModel(datos, new String[] {
			"Nombre", "email", "Edad", "Poblacion"
		}) {
			Class[] columnTypes = new Class[] {
				String.class, String.class, Integer.class, String.class
